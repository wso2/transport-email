...
/**
 * Email Server Connector interface to start and stop the polling operation for given email folder.
 */
public interface EmailServerConnector {
     ...
     * @throws EmailConnectorException If unable to start the polling.
     */
