...
public interface EmailMessageListener {
    ...
    /**
     * Transport will trigger this method when for each email message.
     *
     * @param emailTextMessage contains the msg data.
     */
    void onMessage(EmailBaseMessage emailTextMessage);
}
