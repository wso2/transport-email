...
/**
 * Class implemented to get the relevant action that needed to be carryout for processed mail.
 */
public class ActionForProcessedMail {
    ...
    static void carryOutAction(Message message, Folder folder,
            Constants.ActionAfterProcessed action, Folder folderToMove)
        ...
        try {
            ...
            throw new EmailConnectorException("Error is encountered while carrying out the action '"
